...
## Necessary because --build-option does not apply to legacy builds.
USE_CYTHON = "--use-cython" in sys.argv or os.getenv("USE_CYTHON", "0") == "1"

print(">> Cython enabled?" , USE_CYTHON)
